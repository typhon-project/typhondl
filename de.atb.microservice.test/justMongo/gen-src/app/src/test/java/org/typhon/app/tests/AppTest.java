...
import org.typhon.app.model.repository.AppRepository;
...
public class AppTest {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/app").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
						status().isCreated()).andExpect(
								header().string("Location", containsString("app/")));
	}

	@Test
	public void shouldRetrieveEntity() throws Exception {

		MvcResult mvcResult = mockMvc.perform(post("/app").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/app/search/findByLastName?name={name}", "Baggins")).andExpect(
