package org.typhon.warning.tests;
...
import org.typhon.warning.model.repository.WarningRepository;
...
public class WarningTest {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/warning").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
						status().isCreated()).andExpect(
								header().string("Location", containsString("warning/")));
	}

	@Test
	public void shouldRetrieveEntity() throws Exception {

		MvcResult mvcResult = mockMvc.perform(post("/warning").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/warning/search/findByLastName?name={name}", "Baggins")).andExpect(
